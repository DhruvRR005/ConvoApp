...
const [downloadError, setDownloadError]=useState("")
  ...
  return (
    <>
      <div 
         className='max-w-screen-2xl mx-auto container px-6 md:px-40'>
        <div className='flex h-screen items-center justify-center'>
            <div className='border-2 border-dashed px-4 py-2 md:px-8 md:py-6 border-indigo-400'>
                <h1 className='text-3xl font-bold text-center mb-4'>Convert Word To PDF Online</h1>
                <p className='text-sm  text-center mb-5'>Easily convert word document to PDF format, without having to install any software</p>
            ...
            <div className='flex flex-col items-center space-y-4'>
                ...
                className='text-white bg-blue-300 hover:bg-blue-700 disabled:bg-gray-400 disabled:pointer-events-none  duration-300 font-bold px-4 py-2 rounded-lg'>
                  Convert File
                </button>
                {convert && (
